...
[![Minhas Habilidades](https://skillicons.dev/icons?i=html,css,sass,js,ts,cs,react,nextjs,nodejs,postgres,jest,bootstrap,styledcomponents,vite,git,figma,vscode)](https://skillicons.dev)
